...
namespace EmployeeApi.Migrations
{
    ...
    [Migration("20260427160000_PayrollAuditLog")]
    partial class PayrollAuditLog
    {
            ...
            modelBuilder.Entity("EmployeeApi.Models.Employee", b =>
                {
                    ...
                    b.Property<decimal>("Salary").HasColumnType("numeric");
            ...
            modelBuilder.Entity("EmployeeApi.Models.EmployeeNote", b =>
                {
                    ...
                    b.Property<string>("NoteType").IsRequired().HasColumnType("text");
                    b.HasKey("Id");
            ...
            modelBuilder.Entity("EmployeeApi.Models.LeaveRequest", b =>
                {
                    ...
                    b.Property<string>("ReviewNote").HasColumnType("text");
            ...
            modelBuilder.Entity("EmployeeApi.Models.Payroll", b =>
                {
                    ...
                    b.Property<decimal>("NetPay").HasColumnType("numeric");
            ...
            modelBuilder.Entity("EmployeeApi.Models.PayrollItem", b =>
                {
                    ...
                    b.Property<int>("PayrollId").HasColumnType("integer");
            ...
            modelBuilder.Entity("EmployeeApi.Models.PunchRecord", b =>
                {
                    ...
                    b.Property<int>("EmployeeId").HasColumnType("integer");
                    b.Property<string>("Notes").HasColumnType("text");
                    b.Property<DateTime>("PunchIn").HasColumnType("timestamp with time zone");
                    b.Property<DateTime?>("PunchOut").HasColumnType("timestamp with time zone");
                    b.HasKey("Id");
            ...
            modelBuilder.Entity("EmployeeApi.Models.SalaryHistory", b =>
                {
                    ...
                    b.Property<int>("EmployeeId").HasColumnType("integer");
                    b.Property<decimal>("NewSalary").HasColumnType("numeric");
                    b.Property<decimal>("OldSalary").HasColumnType("numeric");
                    b.Property<string>("Reason").HasColumnType("text");
                    b.HasKey("Id");
